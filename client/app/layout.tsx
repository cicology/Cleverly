...
export const metadata: Metadata = {
  title: "Cleverly AI Grader - Intelligent Test Grading System",
  description:
    "AI-assisted test grading with course materials ingestion, rubric generation, and handwritten submission analysis",
  generator: "v0.app",
  icons: {
    icon: [
      {
